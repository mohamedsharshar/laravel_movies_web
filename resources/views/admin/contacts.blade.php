...
<div class="admin-table-container">
    <div class="admin-table-title"><i class="fas fa-envelope"></i> Contact Messages</div>
    @if(session('success'))
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="{{ route('admin.contacts.delete', $contact->id) }}" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button class="btn-admin-action" onclick="return confirm('Delete this message?')"><i class="fas fa-trash"></i> Delete</button>
                    </form>
                </td>
            </tr>
        @endforeach
